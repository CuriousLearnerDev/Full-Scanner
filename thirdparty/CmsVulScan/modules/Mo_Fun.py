...
import threadpool
import thirdparty.CmsVulScan.CmsPay.merge_pay as Get_list
from thirdparty.CmsVulScan.modules.requ import *
...
class CmsVLmap:
    def __init__(self):
        ...
        self.Len = self.GET[1]
        from thirdparty.CmsVulScan.modules.color import Get_color
    ...
    def Pay_init(self):
        for i in self.PayLoads:
            try:
                ...
                print(fun.times()+fun.col("[-] Error: ensure that the last line of thirdparty/CmsVulScan/Dict/test/payload.txt is null to regenerate payloads","red"))
                exit()
